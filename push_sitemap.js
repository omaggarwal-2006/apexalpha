...
async function main() {
  console.log('Pushing sitemap fix to GitHub...');
  await updateFile(
    'public/sitemap.xml',
    'C:/Users/user/.gemini/antigravity/scratch/apexalpha/public/sitemap.xml',
    'fix: update sitemap.xml - use apexalpha.fun domain and correct blog slugs'
  );
  console.log('Done!');
}
